...
mongoose.connect("mongodb+srv://manya:manya@cluster0.qqoqf5r.mongodb.net/?retryWrites=true&w=majority").then(() => console.log("db successful")).catch((err) => {
...
app.post("/register", async (_req, res) => {
  ...
  try {
    ...
    const details = {
      form: "Registered sucessfully <manya@gmail.com> ",
      to: newUser.email,
